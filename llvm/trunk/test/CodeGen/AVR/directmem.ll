...
; CHECK: array8_store:
; CHECK: ldi [[REG:r[0-9]+]], 1
; CHECK: sts char.array, [[REG]]
; CHECK: ldi [[REG:r[0-9]+]], 2
; CHECK: sts char.array+1, [[REG]]
